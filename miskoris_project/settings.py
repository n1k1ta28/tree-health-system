"""
Django settings for miskoris_project project.
...
WSGI_APPLICATION = 'miskoris_project.wsgi.application'
...
SOCIALACCOUNT_LOGIN_CANCELLED_REDIRECT_URL = '/prisijungimas/'

LOGIN_REDIRECT_URL = '/redirect_after_login/'

SOCIALACCOUNT_LOGIN_ON_GET = True

SOCIALACCOUNT_ADAPTER = 'miskoris_app.adapters.CustomSocialAccountAdapter'
...
#temporary, will delete it later
MEDIA_URL = '/media/'
...
DEFAULT_FROM_EMAIL = 'noreply@miskorius.com'